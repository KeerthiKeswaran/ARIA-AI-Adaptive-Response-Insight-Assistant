...
function LoginPage() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await axios.post("https://slow-dolley-keerthikeswaran-3b59aa11.koyeb.app/login", {
                userMailId: email,
                password: password,
            });
    ...
    const handleGetStarted = async (e) => {
        ...
        try {
            const response = await axios.post("https://slow-dolley-keerthikeswaran-3b59aa11.koyeb.app/signup", {
                userMailId: newEmail, 
